...
- ``sm_pugsetup_snake_captain_picks`` (default 0) - If set to 1, captains will pick players in a "snaked" fashion rather than alternating. ABBAABBA rather than ABABABAB. If set to 2, captains will pick player in ABBABABA rather than ABBAABBA or ABABABAB
