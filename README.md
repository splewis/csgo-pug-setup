...
- **sm_pugsetup_autokicker_enabled** controls in the autokicker is enabled. The autokicker will only kick clients when the game is live and all the spots are taken. Admins are never kicked.
