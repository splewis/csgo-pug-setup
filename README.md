...
- ``sm_pugsetup_maplist`` (default "maps.txt") - Maplist file in addons/sourcemod/configs/pugsetup to use. You may also use a workshop collection ID instead of a maplist you if you have either the [SteamWorks](https://forums.alliedmods.net/showthread.php?t=229556) or [System2](https://forums.alliedmods.net/showthread.php?t=146019) extensions installed.
