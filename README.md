...
- ``sm_pugsetup_forceend_on_players_leave`` (default 0) - Force end if all players leave server? if you have server hibernation actived, is recommendable to enable this cvar to prevens crash.
