...
Place any map list in csgo/addons/sourcemod/configs/pugsetup/ and it will appear in the .setup menu. Some examples are included, you are free to edit/remove/add new maps lists.
...
- **sm_pugsetup_lock_teams** controls if players can switch teams freely when the game goes live or not
